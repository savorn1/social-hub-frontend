  ...
  <div class="flex flex-col h-full">
    ...
    <div class="px-3 py-2.5 border-b border-gray-100">
      <div class="relative">
        ...
        <input
          ...
          class="input pl-8 text-sm py-1.5 bg-gray-50 border-gray-100 focus:bg-white"
    ...
    <div class="flex-1 overflow-y-auto">
      <button
        ...
        :class="activeId === conv.id ? 'bg-blue-50/80' : 'hover:bg-gray-50/80'"
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center justify-between gap-1 mb-1">
            <span
              ...
              :class="activeId === conv.id ? 'text-blue-700' : 'text-gray-900'"
            >
          ...
          <div class="flex items-center gap-1.5 flex-wrap">
            ...
            <span
              ...
              class="inline-flex items-center gap-0.5 text-[10px] font-medium px-1.5 py-0.5 rounded-full bg-amber-50 text-amber-600 border border-amber-100"
            >
            ...
            <span
              ...
              :class="{
                'bg-red-50 text-red-600 border-red-100': conv.priority === 'urgent',
                'bg-orange-50 text-orange-600 border-orange-100': conv.priority === 'high',
                'bg-gray-50 text-gray-500 border-gray-100': conv.priority === 'low',
              }"
            >
              {{ conv.priority }}
            </span>
